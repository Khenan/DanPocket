...
{
    public sealed class TMPText_Animation_Wave : TMPText_Animation
    {
        protected override AnimationType Animation => AnimationType.Wave;
        ...
        protected override void ApplyOnData(TMPText_AnimationData _animationData)
        {
            ...
            _animationData.offset += _amplitude * Mathf.Sin(_animationData.time * _frequency + _characterOffset * _animationData.characterIndex) * Vector2.up;
        }
    }
}