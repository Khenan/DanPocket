...
{
    public sealed class TMPText_Animation_Scale : TMPText_Animation
    {
        protected override AnimationType Animation => AnimationType.Scale;
        ...
        protected override void ApplyOnData(TMPText_AnimationData _animationData)
        {
            ...
            _animationData.scale += _amplitude * Mathf.Sin(_animationData.time * _frequency + _characterOffset * _animationData.characterIndex);
        }
    }
}